...
const ChooseLanguage = () => {
  ...
  return (
    <div>
      ...
      <h1 className='text-[#D9352E] text-xl font-bold text-center sm:p-3 lg:p-5  p-3 font-poppins'>Choose Language</h1>
      <div className='grid grid-cols-2 gap-2 gap-x-8 mx-16 lg:mx-12 lg:py-5 py-2 text-[#D9352E] text-sm sm:gap-1 sm:gap-x-4 '>
        <div className='bg-[#F7D7D5] border-2 border-[#F10086] w-[100%] h-[90%] py-1  flex flex-col items-center justify-center rounded-2xl font-lato'>
          <p className='font-bold'>Hindi</p>
          <p className='text-xs '>हिन्दी</p>
        </div>
        <div className='bg-[#F7D7D5] border-2 border-[#f4c5c2] w-[100%]  h-[90%] py-1  flex flex-col items-center justify-center rounded-2xl font-lato'>
        ...
        <div className='bg-[#F7D7D5] border-2 border-[#F7D7D5] w-[100%] h-[90%] py-1 flex flex-col items-center justify-center rounded-2xl font-lato'>
